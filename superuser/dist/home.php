            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4" style="text-align: center;">Super User - Dashboard</h1>
                        <ol class="breadcrumb mb-4" style="text-align: center;">
                        <?php
                            $TTickets = $dashboard->getTotalTickets();
                        ...
                        <div class="col-xl-3 col-md-4">
                            <?php
                            $oTickets = $dashboard->OverdueTickets();
                            ...
                            <?php
                             $pTickets = $dashboard->getPendingTickets();
                            ...
                            <div class="col-xl-3 col-md-6">
                            <?php
                                $reopened = $dashboard->getReopenedTickets();
                            ...
                            <div class="col-xl-3 col-md-6">
                            <?php
                             $cTickets = $dashboard->getClosedTickets();
