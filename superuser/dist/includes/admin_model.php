...
class admin_model
{
    ...
    public function Tickets()
    {
        ...
        INNER JOIN users ON users.user_id = tickets.user_id
        INNER JOIN it_staff ON it_staff.staff_id = ticket_type.staff_id
        WHERE NOT tickets.ticket_status='Closed' ORDER BY tickets.ticket_id DESC";
        return $dbConn->query($sql);
    }
    ...
    public function allTickets($id)
    {
        ...
        tickets.fault_time, ticket_type.ticket_sla FROM tickets
        INNER JOIN ticket_type ON ticket_type.ticket_type_id = tickets.ticket_type_id
        INNER JOIN users ON users.user_id = tickets.user_id
        INNER JOIN it_staff ON it_staff.staff_id = ticket_type.staff_id ORDER BY tickets.ticket_id DESC";
        return $dbConn->query($sql);
    }
    ...
    public function getReopenedTickets()
    {
        ...
        FROM tickets
        INNER JOIN ticket_type ON ticket_type.ticket_type_id = tickets.ticket_type_id
        WHERE tickets.ticket_status='Reopened'";
        return $dbConn->query($sql);
    }
    ...
    // function that gets the staff details
    ...
    public function get_Staff($id)
    {
        $db = new DBconnection();
        $dbConn = $db->getConnection();
        $sql = "SELECT it_staff.staff_id as staff, ticket_type.ticket_type_id,
        ticket_type.ticket_type
        FROM it_staff
        INNER JOIN ticket_type ON ticket_type.staff_id = it_staff.staff_id
        INNER JOIN tickets ON tickets.ticket_type_id = ticket_type.ticket_type_id
        WHERE ticket_type.ticket_type_id ='$id'";
        return $dbConn->query($sql);
    }
    ...
    public function Re_Assign($ticket_id, $staff_id)
    {
        $db = new DBconnection();
        $dbConn = $db->getConnection();
        $sql = "UPDATE ticket_type
        INNER JOIN tickets ON tickets.ticket_type_id = ticket_type.ticket_type_id
        SET ticket_type.staff_id='$staff_id' WHERE  tickets.ticket_id='$ticket_id'";
        return $dbConn->query($sql);
    }
    ...
    public function myOpenTickets($id)
    {
        $db = new DBconnection();
        $dbConn = $db->getConnection();
        $sql = "SELECT users.full_name as name, ticket_type.user_id as staff, it_staff.full_name, users.department, users.job_title, tickets.ticket_id, tickets.ticket_status, tickets.ticket_no, ticket_type.ticket_type, tickets.fault_time
        FROM tickets
        INNER JOIN ticket_type ON ticket_type.ticket_type_id = tickets.ticket_type_id
        INNER JOIN users ON users.user_id = tickets.user_id
        INNER JOIN it_staff ON it_staff.staff_id = ticket_type.staff_id 
        WHERE NOT tickets.ticket_status='Closed'
        ORDER BY tickets.ticket_id DESC";
        return $dbConn->query($sql);
    }
    ...
    public function reopenedTickets()
    {
        $db = new DBconnection();
        $dbConn = $db->getConnection();
        $sql = "SELECT users.full_name as name, ticket_type.staff_id, it_staff.full_name, users.department, users.job_title, tickets.ticket_id, tickets.ticket_status, tickets.ticket_no, ticket_type.ticket_type, tickets.fault_time
        FROM tickets
        INNER JOIN ticket_type ON ticket_type.ticket_type_id = tickets.ticket_type_id
        INNER JOIN users ON users.user_id = tickets.user_id
        INNER JOIN it_staff ON it_staff.staff_id = ticket_type.staff_id 
        WHERE  tickets.ticket_status='Reopened' ORDER BY tickets.ticket_id DESC";
        return $dbConn->query($sql);
    }
    ...
    public function closedTickets()
    {
        $db = new DBconnection();
        $dbConn = $db->getConnection();
        $sql = "SELECT users.full_name as name, ticket_type.staff_id, it_staff.full_name, ticket_type.ticket_sla, tickets.date_closed, users.department, users.job_title, tickets.ticket_no, tickets.ticket_id, tickets.ticket_status, ticket_type.ticket_type, tickets.fault_time
        FROM tickets
        INNER JOIN ticket_type ON ticket_type.ticket_type_id = tickets.ticket_type_id
        INNER JOIN users ON users.user_id = tickets.user_id
        INNER JOIN it_staff ON it_staff.staff_id = ticket_type.staff_id 
        WHERE  tickets.ticket_status='Closed' ORDER BY tickets.ticket_id DESC";
        return $dbConn->query($sql);
    }
    ...
    public function getOverdueTickets()
    {
        $db = new DBconnection();
        $dbConn = $db->getConnection();
        $sql = "SELECT users.full_name as name, ticket_type.staff_id, it_staff.full_name, users.department, users.job_title,
        tickets.ticket_no, tickets.ticket_id, tickets.ticket_status, ticket_type.ticket_type,
        tickets.fault_time,  ticket_type.ticket_sla
        FROM tickets
        INNER JOIN ticket_type ON ticket_type.ticket_type_id = tickets.ticket_type_id
        INNER JOIN users ON users.user_id = tickets.user_id
        INNER JOIN it_staff ON it_staff.staff_id = ticket_type.staff_id 
        WHERE  tickets.ticket_status='Overdue' ORDER BY tickets.ticket_id DESC";
        return $dbConn->query($sql);
    }
