...
{
    $ticket_id = $_GET['id'];
    $Officer = $admin->getFaultType($id); 
    $list = $Officer->fetch(PDO::FETCH_ASSOC);
    $id = $ticket['staff'];
    $close = $admin->Re_Assign($ticket_id, $id);
}
             ...
             <div class="container-fluid">
                ...
                <form method='POST' class='form-horizontal'>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="small mb-1" for="staff">Assigned To (Me)</label>
                                    <input class="form-control" value="<?=$ticket['staff'];?>" name="staff" id="staff" type="text" disabled>
                                </div>
                            </div>
                       </div>
