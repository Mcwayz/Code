...
if(isset($_POST['submit']))
{
    ...
    $register_user = $admin->editStaff($id, $man_no,$fullname,$email, $department, $title, $role, $usr_pass);
}
             ...
             <main>
                    <div class="container-fluid">
                     ...
                     <div class="container-fluid">
                        ...
                        <div class="form-group">
                            <input class="btn btn-secondary" id="submit" type="submit" onclick="return confirm('Are You Sure You Want to Update IT Staff Details?');" name="submit" value="Update Record" >
                            <input class="btn btn-danger" style="float: right;" id="submit" type="submit" onclick="return confirm('Are You Sure You Want to Delete IT Staff?');" name="delete" value="Delete Record" >
                        </div>
