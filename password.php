                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h5 class="text-center font-weight-light my-4">Password Recovery</h5></div>
                                    <div class="card-body">
                                        ...
                                        <form method="POST">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <input type="submit" class="btn btn-primary" name="submit" value="Recover Password">
                                            </div>
                                        </form>
                                    </div>
                                </div>
